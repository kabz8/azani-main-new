    ...
    const sampleProducts: Omit<Product, 'id' | 'createdAt'>[] = [
      {
        ...
        type: "ready",
        priceKES: 15500,
        images: ["https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=500"],
      ...
      },
      {
        ...
        type: "ready",
        priceKES: 22000,
        images: ["https://images.unsplash.com/photo-1507679799987-c73779587ccf?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=500"],
        availableSizes: ["S", "M", "L"],
      ...
      },
      {
        ...
        type: "ready",
        priceKES: 18500,
        images: ["https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=500"],
        availableSizes: ["S", "M", "L"],
